...
> = {
  kunas: [
    ...
    { key: "username", label: "Usuario", required: true, placeholder: "Usuario del panel Kunas" },
    { key: "password", label: "Contraseña", required: true, placeholder: "Contraseña del panel", type: "password" },
  ],
  cloudbeds: [
